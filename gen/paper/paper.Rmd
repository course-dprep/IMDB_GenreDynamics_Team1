...
knitr::include_graphics("../../gen/data_prep/output/figure/averageRating_frequency_by_genre.pdf")
```

Homoscedasticity and independence appeared to be moderate at best.

```{r plots, echo=FALSE}
knitr::include_graphics("../../gen/data_prep/output/figure/averageRating_homoscedasticity.pdf")
knitr::include_graphics("../../gen/data_prep/output/figure/averageRating_independence.pdf")
```
...
```{r}
knitr::include_graphics("../../gen/data_prep/output/figure/averageRating_linearity.pdf")
```
...
```{r}
knitr::include_graphics("../../gen/analysis/output/figure/plotted_results_regression_analysis.pdf")
```
