...
using five of IMDb's datasets containing movie data. First, these
...
regresses all movie and serie genre's against the average rating's over
a period of 5 years. Additionally, the variables title, movieType and
time are used as control variables to improve the interpret ability of
the estimates.
