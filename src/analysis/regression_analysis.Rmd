...
dir.create("../../gen/analysis/output/figure", recursive = T)
ggsave(filename = "plotted_results_regression_analysis.pdf", plot = last_plot(), device = "pdf", path = "../../gen/analysis/output/figure/")
```
